...
.state('1EPDSResult', {
  url: '/1EPDSResult',
  templateUrl: 'templates/1EPDS/1EPDSResult.html',
  controller: '1EPDSResultCtrl'
  })


.state('2EPDS1', {
  url: '/2EPDS1',
  templateUrl: 'templates/2EPDS/2EPDS1.html',
  controller: '2EPDS1Ctrl'
  })
.state('2EPDS2', {
  url: '/2EPDS2',
  templateUrl: 'templates/2EPDS/2EPDS2.html',
  controller: '2EPDS2Ctrl'
  })
.state('2EPDS3', {
  url: '/2EPDS3',
  templateUrl: 'templates/2EPDS/2EPDS3.html',
  controller: '2EPDS3Ctrl'
  })
.state('2EPDS4', {
  url: '/2EPDS4',
  templateUrl: 'templates/2EPDS/2EPDS4.html',
  controller: '2EPDS4Ctrl'
  })
.state('2EPDS5', {
  url: '/2EPDS5',
  templateUrl: 'templates/2EPDS/2EPDS5.html',
  controller: '2EPDS5Ctrl'
  })
.state('2EPDS6', {
  url: '/2EPDS6',
  templateUrl: 'templates/2EPDS/2EPDS6.html',
  controller: '2EPDS6Ctrl'
  })
.state('2EPDS7', {
  url: '/2EPDS7',
  templateUrl: 'templates/2EPDS/2EPDS7.html',
  controller: '2EPDS7Ctrl'
  })
.state('2EPDS8', {
  url: '/2EPDS8',
  templateUrl: 'templates/2EPDS/2EPDS8.html',
  controller: '2EPDS8Ctrl'
  })
.state('2EPDSResult', {
  url: '/2EPDSResult',
  templateUrl: 'templates/2EPDS/2EPDSResult.html',
  controller: '2EPDSResultCtrl'
  })


.state('BDI1', {
  url: '/BDI1',
  templateUrl: 'templates/BDI/BDI1.html',
  controller: 'BDI1Ctrl'
  })
.state('BDI2', {
  url: '/BDI2',
  templateUrl: 'templates/BDI/BDI2.html',
  controller: 'BDI2Ctrl'
  })
.state('BDI3', {
  url: '/BDI3',
  templateUrl: 'templates/BDI/BDI3.html',
  controller: 'BDI3Ctrl'
  })
.state('BDI4', {
  url: '/BDI4',
  templateUrl: 'templates/BDI/BDI4.html',
  controller: 'BDI4Ctrl'
  })
.state('BDI5', {
  url: '/BDI5',
  templateUrl: 'templates/BDI/BDI5.html',
  controller: 'BDI5Ctrl'
  })
.state('BDI6', {
  url: '/BDI6',
  templateUrl: 'templates/BDI/BDI6.html',
  controller: 'BDI6Ctrl'
  })
.state('BDI7', {
  url: '/BDI7',
  templateUrl: 'templates/BDI/BDI7.html',
  controller: 'BDI7Ctrl'
  })
.state('BDI8', {
  url: '/BDI8',
  templateUrl: 'templates/BDI/BDI8.html',
  controller: 'BDI8Ctrl'
  })
.state('BDI9', {
  url: '/BDI9',
  templateUrl: 'templates/BDI/BDI9.html',
  controller: 'BDI9Ctrl'
  })
.state('BDI10', {
  url: '/BDI10',
  templateUrl: 'templates/BDI/BDI10.html',
  controller: 'BDI10Ctrl'
  })
.state('BDI11', {
  url: '/BDI11',
  templateUrl: 'templates/BDI/BDI11.html',
  controller: 'BDI11Ctrl'
  })
.state('BDI12', {
  url: '/BDI12',
  templateUrl: 'templates/BDI/BDI12.html',
  controller: 'BDI12Ctrl'
  })
.state('BDI13', {
  url: '/BDI13',
  templateUrl: 'templates/BDI/BDI13.html',
  controller: 'BDI13Ctrl'
  })
.state('BDIResult', {
  url: '/BDIResult',
  templateUrl: 'templates/BDI/BDIResult.html',
  controller: 'BDIResultCtrl'
  })
  .state('tab.dash', {
    url: '/dash',
    views: {
